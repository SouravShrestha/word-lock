"use client";
import { useSession, useAccount, fetchProfileFn } from "@word-lock/client";
...
import { MAX_RECENT_GAMES, type PlayerStats, type RecentGameEntry } from "@word-lock/core/game";
