      ...
      <div className="mt-8 flex flex-col gap-8">
        ...
        <Section title="How long it is kept">
          <P>
            ...
            below) removes your email, your username and your leaderboard entries. Games you already
            played stay in your opponents&apos; own match history, but without your username
            attached — the same as if you had never claimed one.
          </P>
        </Section>

        <Section title="Deleting your account">
          <P>
            Settings → Delete account removes your account from inside the app, immediately, with no
            need to contact us. Deleting: ends any game you were waiting to start, forfeits any game
            you were actively playing so your opponent gets a real result rather than a game that
            vanishes, frees your username for someone else to claim, and removes your sign-in so you
            cannot log back in as that account.
          </P>
          <P>
