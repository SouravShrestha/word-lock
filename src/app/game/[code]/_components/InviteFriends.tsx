...
/**
 * Horizontal row of share targets for the waiting lobby. All entries are plain
 * links or clipboard writes: no third-party SDKs and nothing leaves the device
 * except the room URL the user chooses to send.
 */
