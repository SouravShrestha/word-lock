...
export function MoonIcon({ size = DEFAULT_ICON_SIZE, color = "currentColor" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <g fill={color}>
        <circle cx={18.49} cy={11.349} r={1} fill={color} />
        <circle cx={13.99} cy={10.766} r={1} fill={color} />
      </g>
    </svg>
  );
}
